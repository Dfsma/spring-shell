package com.example.clidemo.command;

import com.example.clidemo.shell.ShellHelper;
...
public class EchoCommand {
    ...
    @ShellMethod("Display greeting message to the user whose name is supplied")
